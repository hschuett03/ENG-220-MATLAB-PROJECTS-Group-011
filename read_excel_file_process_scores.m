...
ylabel('Scores');
axis([0 length(col2) -5 max(col11)*1.2]);
grid minor
%
% find mean
%
meanscores = mean(col2);
var_scores = var(col2);
std_scores = sqrt(var_scores);
meanL = ones(length(col2))*meanscores;
%
%
...
S90 = ss90 .* col11;
%
s80_90 = find(col2>=80 & col2<90);
ss80_90 = (col2>=80 & col2<90);
BS = length(s80_90)
S80_90 = ss80_90 .* col2;
%
s70_80 = find(col2>=70 & col2<80);
ss70_80 = (col2>=70 & col2<80);
CS = length(s70_80)
S70_80 = ss70_80 .* col11;
%
s60_70 = find(col2>=60 & col2<70);
ss60 = (col2>=60 & col2<70);
DS = length(s60_70)
S60 = ss60 .* col2;
%
% for 2D matrices
